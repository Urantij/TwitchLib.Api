...
namespace TwitchLib.Api.Core.HttpCallHandlers
{
    ...
    public class TwitchWebRequest : IHttpCallHandler
    {
        ...
        private void HandleWebException(WebException e, string respStr)
        {
            ...
            switch (errorResp.StatusCode)
            {
                ...
                case HttpStatusCode.Unauthorized:
                    ...
                    if (invalidTokenFound)
                        throw new TokenExpiredException("Your request was blocked du to an expired Token. Please refresh your token and update your API instance settings.", respStr);
                    break;
                ...
                case (HttpStatusCode)429:
                    ...
                    throw new TooManyRequestsException("You have reached your rate limit. Too many requests were made", resetTime, respStr);
                default:
                    throw e;
            }
        }
